...
For analysis purposes, we enhanced the Profiles dataset with the following derived metrics based on user id:
...
| levels_attempted | Number of unique combinations of levels and languages attempted | Count of distinct levels | levels |
