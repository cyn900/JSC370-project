...
<div class="nav-header">
  ...
  <div class="nav-links">
    <a href="/JSC370-project/index.html" class="nav-active">Overview</a>
    <a href="/JSC370-project/analysis.html" class="nav-inactive">Detailed Analysis</a>
  </div>
</div>
...
datatable(summary_stats,
          ...
          rownames = FALSE,
          caption = "Table 1: Summary Statistics of User Engagement Metrics")
```
...
[Continue to Detailed Analysis →](analysis.html) 
```
</div>