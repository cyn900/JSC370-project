...
After 10 months of operation and 92 users, this analysis investigates three key aspects of user behavior:
...
3.  **Language Mode Preferences and Learning Patterns**
    -   Research Question: "How do users engage with different language modes and what patterns emerge in their learning behavior?"
    -   Hypothesis: Users show consistent preferences in language modes and exhibit regular usage patterns aligned with their daily routines.
    -   Rationale: Understanding language mode preferences and temporal patterns can help optimize content delivery and user experience.
